...
class MaternalComplicationRepositoryPostgres extends MaternalComplicationRepository {
  ...
  async addMaternalComplication(payload) {
    ...
    const query = {
      text: `INSERT INTO maternal_complications(id, maternal_history_id, is_handled, is_referred, complication_type, description, come_condition, back_condition, complication_date) 
