...
const MaternalTableTestHelper = {
  ...
  async addMaternal({
    id = 'maternal-123', userId = 'user-123', menarcheDate = '2021-08-22', martialDate = '2021-08-22', numberOfMarriage = '1', martialStatus = 'single',
  }) {
    const query = {
      text: 'INSERT INTO maternals(id, user_id, menarche_date, martial_date, number_of_marriage, martial_status) VALUES($1, $2, $3, $4, $5, $6)',
